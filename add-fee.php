        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-primary">
              <div class="card-header custom-green-btn">
...
?>
   ...
   <option value="Information Technology">Information Technology</option>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Amount (ZMW) </label>
                ...
                <div class="card-footer">
                  <button type="submit" name="btnAdd" class="btn btn-primary custom-green-btn">Add</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
              ...
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <td><div align="center"><?php echo $row['session']; ?></div></td>
                     <td><div align="center">ZMW<?php echo number_format((float) $row['amount'] ,2); ?></div></td>
