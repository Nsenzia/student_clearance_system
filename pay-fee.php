...
$ID = $_SESSION["ID"];
$matric_no = $_SESSION["Student Number"];
$dept = $_SESSION['dept'];
                                ...
                                <form role="form" method="POST">
                                    ...
                                    <label>Amount</label></strong>
									  ...
									  <div>
										...
										<button name="btnpay" class="btn btn-primary custom-green-btn" onClick="return confirmpayment();"><i class="fa fa-credit-card"></i> Pay</button>
                                    </div>
                                </form>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <p class="text-center style1"><strong>SCHOOL FEES :</strong>    <span class="badge badge-info">ZMW<?php echo number_format((float) $tot_fee ,2); ?></span></p>
                                <p class="text-center style1"><strong>TOTAL PAID :</strong>  <span class="badge badge-warning"ZMW<?php echo number_format((float) $tot_pay ,2); ?></span>   </p>
                                <p class="text-center style1"><strong>OUTSTANDING FEE :</strong>  <span class="badge badge-primary custom-green-btn">ZMW<?php echo number_format((float) $outstanding_fee ,2); ?></span>   </p>
